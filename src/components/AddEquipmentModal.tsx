...
const AddEquipmentModal: React.FC<AddEquipmentModalProps> = ({
  ...
  const handleResponsibleChange = (userId: string) => {
    ...
    if (selectedUser) {
      setFormData(prev => ({
        ...prev,
        responsible: selectedUser.username,
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select 
                value={formData.type || ''} 
                onValueChange={(value: EquipmentType) => handleChange('type', value)}
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Select value={formData.status} onValueChange={(value: EquipmentStatus) => handleChange('status', value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              <Label htmlFor="maintenanceDate">下次维护日期 *</Label>
              <Input
                id="maintenanceDate"
                type="date"
          ...
          {/* SOP上传 */}
          <SOPUploader
            sopFileUrl={formData.sopFileUrl}
            sopFileName={formData.sopFileName}
            onSOPChange={(fileUrl, fileName) => {
              handleChange('sopFileUrl', fileUrl);
              handleChange('sopFileName', fileName);
            }}
          />
