-- Create app_role enum type with all role values
CREATE TYPE public.app_role AS ENUM ('admin', 'user', 'manager', 'scientist', 'analyst');

-- Update profiles table to use the new role type
