    	...
    	extend: {
    		colors: {
    			...
    			icon: {
    				...
    				'orange-bg': 'hsl(var(--icon-orange-bg))',
    				red: 'hsl(var(--icon-red))',
    				'red-bg': 'hsl(var(--icon-red-bg))',
    				teal: 'hsl(var(--icon-teal))',
    				'teal-bg': 'hsl(var(--icon-teal-bg))',
    				green: 'hsl(var(--icon-green))',
    				'green-bg': 'hsl(var(--icon-green-bg))',
    				purple: 'hsl(var(--icon-purple))',
    				'purple-bg': 'hsl(var(--icon-purple-bg))',
    				amber: 'hsl(var(--icon-amber))',
    				'amber-bg': 'hsl(var(--icon-amber-bg))'
    			}
    		},
    		borderRadius: {
    			lg: 'var(--radius)',
    		...
    		fontFamily: {
    			...
    			serif: ['Plus Jakarta Sans', 'ui-serif', 'Georgia', 'Cambria', 'Times New Roman', 'Times', 'serif'],
